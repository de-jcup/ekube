...
public class NamespaceSupport extends AbstractSupport {
	...
	private class AddAllChildrenExcecutable implements Fabric8ioSafeExecutableNoData<NamespaceContainer> {
		...
		public Void execute(EKubeContext context, KubernetesClient client, NamespaceContainer namespaceContainer,
				Object ignore) {
			Fabric8ioGenericExecutionAction<NamespaceContainer, Object, Void> x = new Fabric8ioGenericExecutionAction<>(addAllChildrenExcecutable, EKubeActionIdentifer.REFRESH_CHILDREN, context, client, namespaceContainer, ignore);
