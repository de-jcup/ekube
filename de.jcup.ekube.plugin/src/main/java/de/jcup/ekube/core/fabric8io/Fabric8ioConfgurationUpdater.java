...
/**
 * This updater will upate only EKubeConfiguration - and NEVER the original KubeConfiguration.
 * @author Albert Tregnaghi
 *
 */
public class Fabric8ioConfgurationUpdater {
	
	/**
	 * Updates list of available kubernetes contexts, does also setup current context if not already set in configuration
	 * @param ekubeContext
	 */
