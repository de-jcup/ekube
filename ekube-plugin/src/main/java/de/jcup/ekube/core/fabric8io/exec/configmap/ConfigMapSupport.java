...
public class ConfigMapSupport extends AbstractSupport {
    ...
    UpdateConfigMapsExecutable updateConfigMapsExecutable = new UpdateConfigMapsExecutable(this);
    private AddConfigMapsFromNamespaceExecutable addConfigMapsFromNamespaceExecutable = new AddConfigMapsFromNamespaceExecutable(this);
